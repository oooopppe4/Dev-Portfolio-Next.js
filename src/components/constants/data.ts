...
export const ABOUT_ME = {
  ...
  phone: "+91 1234567890", // Optional: Your phone number
  description: [
...
export const SOCIAL_LINKS = {
  ...
  whatsapp: "https://wa.me/1234567890", // Format: https://wa.me/PHONENUMBER (include country code, no + or spaces)
...
export const PROJECTS = [
  {
    name: "Project 1",
    description:
      "Describe your project 1 here. Example: A web app for tracking habits.",
  ...
  },
  {
    name: "Project 2",
    description:
      "Describe your project 2 here. Example: An e-commerce site for books.",
...
export const ACHIEVEMENTS = [
  {
    title: "Achievement 1",
    description:
      "Describe your achievement here. Example: Won first place in a hackathon.",
    date: "2024",
    link: "https://example.com", // Optional: link to certificate, article, etc.
    icon: "🏆", // Optional: emoji or icon
  },
  {
    title: "Achievement 2",
    description: "Describe another achievement here.",
    date: "2023",
    link: "", // Optional
    icon: "🎖️", // Optional
  },
